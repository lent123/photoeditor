var photoEditor = {
    ...
    initCanvas: function(urlImg, nameTag) {
        ...
        var heightDivEdit = document.getElementById('pe-container').offsetHeight*0.88;
